...
manifest[6]="https://download.blender.org/release/Blender4.2/blender-4.2.16.sha256 \
https://download.blender.org/release/Blender4.2/blender-4.2.16-linux-x64.tar.xz"
