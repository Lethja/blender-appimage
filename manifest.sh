...
manifest[5]="https://download.blender.org/release/Blender3.6/blender-3.6.17.sha256 \
https://download.blender.org/release/Blender3.6/blender-3.6.17-linux-x64.tar.xz"

manifest[6]="https://download.blender.org/release/Blender4.2/blender-4.2.3.sha256 \
