...
manifest[6]="https://download.blender.org/release/Blender4.2/blender-4.2.15.sha256 \
https://download.blender.org/release/Blender4.2/blender-4.2.15-linux-x64.tar.xz"

manifest[7]="https://download.blender.org/release/Blender4.5/blender-4.5.4.sha256 \
